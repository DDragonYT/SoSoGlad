...
ROLL_EVENTS = [
    ...
    Event(chance = 204800, event_type = EventType.TEXT, 
            event= "**A ✨SHINY✨ 🔥ALPHA🔥 💪PERFECT STAT💪 MESSAGE appeared! Try to catch it while you can.**",
            badge="perfect_alpha_shiny_hunter"),
